...
function Signup({ setIsAuthenticated }) {  // Add setIsAuthenticated as a prop
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://dangi-backend-login-register.vercel.app/api/signup', formData);
